...
// 🔍 DIAGNOSTIC LOG: Right-click your live app -> Inspect -> Console to see this value
console.log("CRITICAL DEBUG: Vite is using API URL ->", import.meta.env.VITE_API_URL);
